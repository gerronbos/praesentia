<?php
    ...
    echo FormRepositorie::textarea('Omschrijving','', ['placeholder' => 'Nawab is gay']);
    echo FormRepositorie::radio('hi',['Nawab is gay'=>'test1','Nawab is super gay'=>'test2', 'Nawab is ultra gay'=>'test3'],'Jesse is ultra gay');
