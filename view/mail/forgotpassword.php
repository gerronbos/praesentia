                                ...
                                <tr><td align="center" bgcolor="#fbfcfd">
                                        <font face="Arial, Helvetica, sans-serif" size="4" color="#57697e" style="font-size: 15px;">
                                            <table width="90%" border="0" cellspacing="0" cellpadding="0">
                                                <tr><td>
                                                        Beste ::fullname::<br/>
                                                        U (of iemand anders) heeft onlangs vermeld dat u uw wachtwoord bent vergeten.<br/>
                                                        Hiervoor krijgt u een link die u toestaat om (Binnen 1 uur) een nieuw wachtwoord in te stellen.<br/>
                                                    </td></tr>
                                                <tr><td align="center">
